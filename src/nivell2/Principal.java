...
public class Principal {
	...
	public static void main(String[] args) {
		...
		if(floristNum==0) {
			...
			/*if(requireString("No hi ha cap floristeria a la base de dades amb el nom "+floristName+". "
					+ "Vols crear-la? \n1 per crear-la, qualsevol altra lletra per sortir.").equals("1")){
			floristNum=dc.insertShop(floristName);
			}else {
	...
	public static boolean showMenu(boolean sortirMenu) {
        ...
        switch (indexSwitch) {
            ...
            case "7":
            	...
            	currentStockValue=(float) stock.stream()
            ...
            case "8":
            	...
            	totalSalesValue=(float)ticketList.stream()
                ...
                if (valueSelected == 0) {
                    ...
                    if (ticket.getSales().size() > 0) {
                        ...
                        for(int i:productId) {
                            ...
                            //eliminar valor idshop del producto y añadir idticket al producto (tabla producto)
